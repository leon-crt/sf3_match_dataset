-- TODO: 
--      - decide what to do with throws as they are not easily detectable and if they are encoded in the state variable, they are all different
--      - meter parameter does not reflect truth. It is 0 even with one full bar or when it is completely full -> find out how to get how long a bar is so that you can sum it to the bar content to get actual meter
Frame_counter = 1
Buff_size = 100
Turbo = false
...
function FeatureExtraction()
    ...
    then
        -- Extract P1 and P2 character and super info
    ...
    then
        ...
        -- print("hit by Normal P1: " .. hitByNP1)
        -- print("hit by Special P1: " .. hitBySP1)
        -- print("hit by Super P1: " .. hitBySAP1)
        -- print("hit by Other P1: " .. hitByOtherP1)
        -- print("hit by Normal P2: " .. hitByNP2)
        -- print("hit by Special P2: " .. hitBySP2)
        -- print("hit by Super P2: " .. hitBySAP2)
        -- print("hit by Other P2: " .. hitByOtherP2)

        -- print("health P1: " .. healthP1)
        -- print("health P2: " .. healthP2)
        -- print("super P1: " .. superP1)
        -- print("super P2: " .. superP2)
        -- print("super bar count P1: " .. superCountP1)
        -- print("super bar count P2: " .. superCountP2)
    ...
    elseif in_match == 6 and P1.posX[1] ~= nil -- if round has just ended and classes are not empty just write them to file and reset all round specific values
    then
